        ...
        <Dflex>
          <VerticalTimeline>
            ...
            >
              ...
              <CompanyText>
                Neointeraction Designs, Bangalore, India
              </CompanyText>
              <KeywordsText>
              ...
              >
                <MoreInfo isOpen={open}>
                  <SummaryList>
                    <SummaryListItem>
                      Used Component Driven Development (CDD) approach to
                      develop and maintain complex web components using React.js
                      and StoryBook.js.
                    </SummaryListItem>
                    <SummaryListItem>
                    ...
                    <SummaryListItem>
                      ...
                      developed UI for Microservices apps using
                      React-Typescript, styled-components & StoryBook.js.
                    </SummaryListItem>
                  </SummaryList>
                </MoreInfo>
              </motion.div>
            ...
            <VerticalTimelineElement
              className="vertical-timeline-element--work"
              date="2015 - 2016"
              iconStyle={{ background: "#D4AC0D", color: "#fff" }}
              icon={<VscBriefcase />}
            >
                ...
                <MoreInfo isOpen={open2}>
                  <SummaryList>
                    <SummaryListItem isLight>
                      Designed and developed fully functional responsive
                      websites for clients using HTML, CSS, JQuery and PHP.
                    </SummaryListItem>
                    <SummaryListItem isLight>
